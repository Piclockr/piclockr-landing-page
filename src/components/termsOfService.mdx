...
We are Piclockr ("**Company**," "**we**," "**us**," "**our**").

We operate the website [https://www.piclockr.com](https://www.piclockr.com/) (the "**Site**"), as well as any other
related products and services that refer or link to these legal terms (the "**Legal Terms**") (collectively, the
"**Services**").

Piclockr offers a platform where users can store images and photos encrypted in the cloud. What sets Piclockr apart is
the encryption technology used. We employ end-to-end encryption where all image data is encrypted and decrypted on the
user's device, making unauthorized access impossible. Piclockr provides a secure solution with which you can safely
archive your personal moments.

You can contact us by email at info@piclockr.com.

These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity
("**you**"), and Piclockr, concerning your access to and use of the Services. You agree that by accessing the Services,
you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE
...
will become effective upon posting or notifying you by terms@piclockr.com, as stated in the email message. By continuing
...
[14\. COPYRIGHT INFRINGEMENTS](#copyrightno)[](#terms)
...
Legal Terms, please address your request to: info@piclockr.com. If we ever grant you the permission to post, reproduce,
...
-   confirm that you have read and agree with our "[PROHIBITED ACTIVITIES](#prohibited)" and will not post, send,
    publish, upload, or transmit through the Services any Submission nor post any Contribution that is illegal,
    harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or
...
"[](#dmca)[COPYRIGHT INFRINGEMENTS](#copyrightno)" section below.
...
-   Payment methods provided by Paddle
...
<br />
<h3 id="cancel">7\. CANCELLATION</h3>
...
If you are unsatisfied with our Services, please email us at info@piclockr.com.
...
<br />
<h3 id="ugc">9\. USER GENERATED CONTRIBUTIONS</h3>
...
"Contributions"). Contributions may be viewable by other users of the Services and through third-party websites. As
such, any Contributions you transmit may be treated as non-confidential and non-proprietary. When you create or make
...
<br />
<h3 id="license">10\. CONTRIBUTION LICENSE</h3>
...
<br />
<h3 id="thirdparty">11\. THIRD-PARTY WEBSITES AND CONTENT</h3>
...
<br />
<h3 id="sitemanage">12\. SERVICES MANAGEMENT</h3>
...
<br />
<h3 id="ppyes">13\. PRIVACY POLICY</h3>

We care about data privacy and security. Please review our Privacy Policy:
**[https://www.piclockr.com/legal/privacypolicy](https://www.piclockr.com/legal/privacypolicy)**. By using the Services,
you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the
Services are hosted in the United States and Europe. If you access the Services from any other region of the world with
laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in
the United States and Europe, then through your continued use of the Services, you are transferring your data to the
United States and Europe, and you expressly consent to have your data transferred to and processed in the United States
and Europe.

We utilize Cloudflare as our cloud provider, and our system is designed to route traffic to the nearest colocation
center based on the user's geolocation. However, depending on the configuration of your ISP, it's possible that the
routing may behave unexpectedly, causing the traffic to be routed to a different colocation center than anticipated.

<br />
<h3 id="copyrightno">14\. COPYRIGHT INFRINGEMENTS</h3>
...
<br />
<h3 id="terms">15\. TERM AND TERMINATION</h3>
...
<br />
<h3 id="modifications">16\. MODIFICATIONS AND INTERRUPTIONS</h3>
...
<br />
<h3 id="law">17\. GOVERNING LAW</h3>

These Legal Terms are governed by and interpreted following the laws of Germany, and the use of the United Nations
Convention of Contracts for the International Sales of Goods is expressly excluded. You irrevocably submit to the
...
<br />
<h3 id="liability">20\. LIMITATIONS OF LIABILITY</h3>
...
<br />
<h3 id="electronic">23\. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
...
please contact us at: **info@piclockr.com**
